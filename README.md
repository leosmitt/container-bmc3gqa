...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-bmc3gqa.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-bmc3gqa.containers.anotherwebservice.com/
...
```
git clone git@github.com:leosmitt/container-bmc3gqa.git
cd container-bmc3gqa
```
...
```
docker attach container-bmc3gqa
```
